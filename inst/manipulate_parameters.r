...
pars <- c(15,5.409,57.34,60,164.9,3.44887)
...
manipulate({
  ...
  pars <- c(par1, par2, par3, par4, par5, par6)
...
par1 = slider(min = 0, max = 200, initial = pars[1], step = 0.1),
par2 = slider(min = 0, max = 100, initial = pars[2], step = 0.1),
par3 = slider(min = 0, max = 100, initial = pars[3], step = 0.01),
par4 = slider(min = 0, max = 100, initial = pars[4], step = 0.01),
par5 = slider(min = 0, max = 250, initial = pars[5], step = 0.1),
